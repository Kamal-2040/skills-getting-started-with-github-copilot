...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique training and swim meet preparation",
    ...
    "Art Workshop": {
        "description": "Creative arts sessions in painting, drawing, and sculpture",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["sophia@mergington.edu", "isabella@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Build and program robots for friendly competitions",
